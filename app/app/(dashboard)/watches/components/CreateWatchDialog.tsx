...
export function CreateWatchDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger render={<Button className="bg-primary hover:bg-primary-hover text-on-primary font-sans rounded-lg px-5 shadow-sm transition-all" />}>
        Create Watch
      </DialogTrigger>
      <DialogContent className="sm:max-w-[640px] max-h-[85dvh] flex flex-col bg-surface-elevated border-hairline shadow-high rounded-2xl p-0 overflow-hidden">
