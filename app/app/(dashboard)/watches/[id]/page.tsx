...
export default async function WatchDetailPage({ params, searchParams }: WatchDetailPageProps) {
  const { id } = await params;
  const selectedFindingId = (await searchParams)?.finding;
  ...
  return <WatchDetailView watch={watch} findings={findings} digests={digests} selectedFindingId={selectedFindingId} />;
}
